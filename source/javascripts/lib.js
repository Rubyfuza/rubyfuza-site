...
! function e(t, n, a) {
  ...
  2: [function (e, t, n) {
    ...
    var o = (e("./getPaper"), e("./tween")),
      ...
      s = function () {
        function e(t, n, r, s) {
          var d = this;
          if (this.stopped = !1, this.startTime = (new Date).getTime(), this.settings = a(r), this.item = t, this.itemForAnimations = this.settings.parentItem || this.item, this.repeat = this.settings.repeat || 0, "function" == typeof this.settings.repeat) {
            var u = this.settings.repeat;
            this.repeatCallback = function () {
              return u(t, d) ? new e(t, n, r, s) : null
            }
          } else(!0 === this.repeat || this.repeat > 0) && (this.repeatCallback = function (a) {
            return r.repeat = a, new e(t, n, r, s)
          });
          this.tweens = [], this.ticker = null, this._continue = s, void 0 === this.itemForAnimations.data && (this.itemForAnimations.data = {}), void 0 === this.itemForAnimations.data._animatePaperAnims && (this.itemForAnimations.data._animatePaperAnims = []), this._dataIndex = this.itemForAnimations.data._animatePaperAnims.length, this.itemForAnimations.data._animatePaperAnims[this._dataIndex] = this;
          for (var p in n) n.hasOwnProperty(p) && this.tweens.push(new o.Tween(p, n[p], this));
          "onFrame" === this.settings.mode && (this.ticker = i.add(this.itemForAnimations, "_animate" + this.startTime + (Math.floor(999 * Math.random()) + 1), function () {
            d.tick()
          }))
        }
        return e.prototype.tick = function () {
          ...
          for (var n = Math.max(0, e.startTime + e.settings.delay + e.settings.duration - t), a = n / e.settings.duration || 0, o = 1 - a, i = 0, r = e.tweens.length; i < r; i++) e.tweens[i].run(o);
          return void 0 !== e.settings.step && e.settings.step.call(e.item, {
            percent: o,
            remaining: n
          }), void 0 !== e.settings.parentItem ? e.settings.parentItem.project.view.draw() : e.item.project.view.draw(), e.settings.mode, o < 1 && r ? n : (e.end(), !1)
          ...
          void 0 === e && (e = !1);
          var t = this;
          if ("onFrame" === t.settings.mode && i.remove(t.itemForAnimations, t.ticker), void 0 !== t.settings.complete && t.settings.complete.call(t.item, this), t.settings.mode, "function" == typeof t._continue && t._continue.call(t.item), t.itemForAnimations.data._animatePaperAnims[t._dataIndex] = null, !e && "function" == typeof t.repeatCallback) {
            var n = t.repeat;
  ...
  3: [function (e, t, n) {
    ...
    for (var a = ["Quad", "Cubic", "Quart", "Quint", "Expo"], o = 0, i = a.length; o < i; o++) n.easing[a[o]] = function (e) {
    ...
    for (var r in n.easing)
      if (n.easing.hasOwnProperty(r)) {
        var s = n.easing[r];
        n.easing["easeIn" + r] = s, n.easing["easeOut" + r] = function (e) {
          return 1 - s(1 - e)
        }, n.easing["easeInOut" + r] = function (e) {
          return e < .5 ? s(2 * e) / 2 : 1 - s(-2 * e + 2) / 2
        }
      }
  }, {}],
  4: [function (e, t, n) {
    ...
    var a = e("./animation"),
      o = function (e, t) {
        ...
        var o = 0;
        return new a.Animation(e, n[o].properties, n[o].settings, function t() {
    ...
    n.grow = function (e, t) {
      ...
      for (var n = 2 * Math.floor(t ? t.nb || 2 : 2), a = Math.floor(t ? t.movement || 40 : 40), i = [], r = !0; n > 0; n--) {
        var s = n % 2 ? "+" : "-",
          d = a,
          u = null;
        1 === n && t && void 0 !== t.complete && (u = t.complete), (r || 1 === n) && (d /= 2, r = !1), i.push({
          properties: {
            position: {
              x: s + d
            }
      ...
      var n = 500,
        a = void 0,
        i = "swing";
      void 0 !== t && (void 0 !== t.duration && (n = Number(t.duration)), "function" == typeof t.complete && (a = t.complete), void 0 !== t.easing && (i = t.easing)), o(e, {
        properties: {
          opacity: 1
        },
        settings: {
      ...
      var n = 500,
        ...
        i = 50,
        r = "swing";
      void 0 !== t && (void 0 !== t.duration && (n = Number(t.duration)), "function" == typeof t.complete && (a = t.complete), void 0 !== t.easing && (r = t.easing), void 0 !== t.distance && (i = t.distance)), o(e, {
        properties: {
          opacity: 1,
          position: {
            y: "-" + i
  ...
  6: [function (e, t, n) {
    ...
    n.animate = function (e, t) {
      ...
      if (e.data._animatePaperAnims)
        for (var a = 0, o = e.data._animatePaperAnims.length; a < o; a++) e.data._animatePaperAnims[a] && e.data._animatePaperAnims[a].stop(t, n);
      return e
    }, n.extendEasing = i.easing.extendEasing, n.frameManager = r, n.fx = o, d.Item.prototype.animate || (d.Item.prototype.animate = function (e) {
      return n.animate(this, e)
    }), d.Item.prototype.stop || (d.Item.prototype.stop = function (e, t) {
  ...
  7: [function (e, t, n) {
    ...
    function a(e) {
      ...
      if (void 0 === t.data && (t.data = {}), void 0 !== t.data._customHandlers && t.data._customHandlersCount > 0)
        for (var n in t.data._customHandlers) t.data._customHandlers.hasOwnProperty(n) && "function" == typeof t.data._customHandlers[n] && t.data._customHandlers[n].call(t, e)
    }
    n.__esModule = !0, n.add = function (e, t, n, o) {
      return void 0 === e.data._customHandlers && (e.data._customHandlers = {}, e.data._customHandlersCount = 0), e.data._customHandlers[t] = n, e.data._customHandlersCount += 1, e.data._customHandlersCount > 0 && (void 0 !== o ? o.onFrame = a : e.onFrame = a), t
    }, n.remove = function (e, t) {
      void 0 !== e.data._customHandlers && (e.data._customHandlers[t] = null, e.data._customHandlersCount -= 1, e.data._customHandlersCount <= 0 && (e.data._customHandlersCount = 0))
    }
  }, {}],
  8: [function (e, t, n) {
    var a = e("paper");
  ...
  9: [function (e, t, n) {
    ...
    for (var r = /^([+\-])(.+)/, s = function (e, t, n) {
        ...
        scale: {
          get: function (e) {
            return e.item.data._animatePaperVals || (e.item.data._animatePaperVals = {}), void 0 === e.item.data._animatePaperVals.scale && (e.item.data._animatePaperVals.scale = 1), e.item.data._animatePaperVals.scale
          },
          set: function (e) {
            ...
            var a = !1;
            void 0 !== e.A.settings.center && (a = e.A.settings.center), void 0 !== e.A.settings.scaleCenter && (a = e.A.settings.scaleCenter), !1 !== a ? e.item.scale(n, a) : e.item.scale(n)
          }
        },
        rotate: {
          get: function (e) {
            return e.item.data._animatePaperVals || (e.item.data._animatePaperVals = {}), void 0 === e.item.data._animatePaperVals.rotate && (e.item.data._animatePaperVals.rotate = -0), e.item.data._animatePaperVals.rotate
          },
          set: function (e) {
            ...
            var a = !1;
            void 0 !== e.A.settings.center && (a = e.A.settings.center), void 0 !== e.A.settings.rotateCenter && (a = e.A.settings.rotateCenter), !1 !== a ? e.item.rotate(n, a) : e.item.rotate(n)
          }
        },
        translate: {
          get: function (e) {
            return e.item.data._animatePaperVals || (e.item.data._animatePaperVals = {}), void 0 === e.item.data._animatePaperVals.translate && (e.item.data._animatePaperVals.translate = new paper.Point(0, 0)), e.item.data._animatePaperVals.translate
          },
          set: function (e) {
        ...
        position: {
          ...
          ease: function (e, t) {
            void 0 === e._easePositionCache && (e._easePositionCache = {
              x: 0,
              y: 0
            });
            var n = a(e.end.x || 0),
            ...
            return void 0 !== e.end.x ? "+" === i ? (e.now.x = u(o) - e._easePositionCache.x, e._easePositionCache.x += e.now.x) : "-" === i ? (e.now.x = u(o) - e._easePositionCache.x, e._easePositionCache.x += e.now.x, e.now.x = -e.now.x) : (e.now.x = (o - e.start.x) * t - e._easePositionCache.x, e._easePositionCache.x += e.now.x) : e.now.x = 0, void 0 !== e.end.y ? "+" === d ? (e.now.y = u(s) - e._easePositionCache.y, e._easePositionCache.y += e.now.y) : "-" === d ? (e.now.y = u(s) - e._easePositionCache.y, e._easePositionCache.y += e.now.y, e.now.y = -e.now.y) : (e.now.y = (s - e.start.y) * t - e._easePositionCache.y, e._easePositionCache.y += e.now.y) : e.now.y = 0, e.now
          }
        },
        pointPosition: {
          get: function (e) {
        ...
        Color: {
          ...
          ease: function (e, t) {
            for (var n = i(e.item[e.prop]), o = function (e) {
                return (e || 0) * t
              ...
              var p = a(e.end[u] || 0),
                c = p.value,
                m = p.direction;
              void 0 !== e.end[u] ? "+" === m ? (e.now[u] = o(c) - e._easeColorCache[u], e._easeColorCache[u] += e.now[u]) : "-" === m ? (e.now[u] = o(c) - e._easeColorCache[u], e._easeColorCache[u] += e.now[u], e.now[u] = -e.now[u]) : (e.now[u] = (c - e.start[u]) * t - e._easeColorCache[u], e._easeColorCache[u] += e.now[u]) : e.now[u] = 0
            }
            return e.now
          }
        }
      }, u = ["fill", "stroke"], p = 0, c = u.length; p < c; p++) d[u[p] + "Color"] = d.Color;
    n._tweenPropHooks = d, n._pointDiff = s, n.extendPropHooks = function (e) {
  ...
  10: [function (e, t, n) {
    ...
    var a = e("./prophooks"),
      ...
      i = function () {
        function e(e, t, n) {
          var a = this;
          a.A = n, a.item = n.item, a.prop = e, a.end = t, a.start = a.cur(), "string" == typeof a.end && "+" === a.end.charAt(0) ? a.end = a.start + parseFloat(a.end) : "string" == typeof a.end && "-" === a.end.charAt(0) && (a.end = a.start + parseFloat(a.end)), a.now = a.cur(), a.direction = a.end > a.start ? "+" : "-"
        }
        return e.prototype.cur = function () {
          var e = this,
          ...
          return i && i.ease ? i.ease(n, t) : n.now = (n.end - n.start) * t + n.start, i && i.set ? i.set(n) : a._tweenPropHooks._default.set(n), n
        }, e
      }();
    n.Tween = i
  }, {
